...
public class Product {
	...
	public Product(String id, String productName, int price, int discountedPrice, String description, String trader){
		this.id = id;
	...
	public Product(String productName, int price, int discountedPrice, String description, String trader){
